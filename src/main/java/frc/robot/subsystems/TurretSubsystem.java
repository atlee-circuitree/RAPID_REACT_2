...
public class TurretSubsystem extends SubsystemBase {
  ...
  public LaunchVelocity[] getDistanceToVelocityArray(){
    ...
    robotDistance[1] = new LaunchVelocity(2400, 6000);
    robotDistance[2] = new LaunchVelocity(2400, 6000);
    robotDistance[3] = new LaunchVelocity(2400, 6000);
    robotDistance[4] = new LaunchVelocity(2400, 6000);
    robotDistance[5] = new LaunchVelocity(2400, 6000);
    robotDistance[6] = new LaunchVelocity(2400, 6000);
    robotDistance[7] = new LaunchVelocity(2400, 6000);
    robotDistance[8] = new LaunchVelocity(2400, 6000);
    robotDistance[9] = new LaunchVelocity(2400, 6000);
    robotDistance[10] = new LaunchVelocity(2400, 6000);
    robotDistance[11] = new LaunchVelocity(2400, 6000);
    robotDistance[12] = new LaunchVelocity(2400, 6000);
    robotDistance[13] = new LaunchVelocity(2400, 6000);
    robotDistance[14] = new LaunchVelocity(3000, 12000);
    robotDistance[15] = new LaunchVelocity(3000, 12000);
    robotDistance[16] = new LaunchVelocity(3000, 12000);
    robotDistance[17] = new LaunchVelocity(3000, 12000);
    robotDistance[18] = new LaunchVelocity(3000, 12000);
    robotDistance[19] = new LaunchVelocity(3000, 12000);
    robotDistance[20] = new LaunchVelocity(5200, 11000);
    robotDistance[21] = new LaunchVelocity(5250, 11000);
    ...
    robotDistance[30] = new LaunchVelocity(7700, 8700);
    robotDistance[31] = new LaunchVelocity(8600, 8000);
    robotDistance[32] = new LaunchVelocity(8800, 8000);
    robotDistance[33] = new LaunchVelocity(8950, 8150);
    robotDistance[34] = new LaunchVelocity(9100, 8300);
    ...
    robotDistance[43] = new LaunchVelocity(11700, 7600);
    robotDistance[44] = new LaunchVelocity(13200, 6700);
    robotDistance[45] = new LaunchVelocity(13500, 6600);
    robotDistance[46] = new LaunchVelocity(13800, 6500);
    robotDistance[47] = new LaunchVelocity(13800, 6500);
    robotDistance[48] = new LaunchVelocity(13800, 6650);
    robotDistance[49] = new LaunchVelocity(13850, 6850);
    robotDistance[50] = new LaunchVelocity(13850, 7500);
  ...
  public boolean checkShootVelocity(double topVelocity, double bottomVelocity, Timer timer, double timeout) {
    ...
    if ((Math.abs(topShootMotor.getSelectedSensorVelocity() - topVelocity) <= 300 && Math.abs(bottomShootMotor.getSelectedSensorVelocity() - bottomVelocity) <= 300) || timer.get() > timeout) {
